...
const char kSelfCustodyAvailable[] = "brave.rewards.self_custody_available";
const char kSelfCustodyInvitationDismissed[] =
    "brave.rewards.self_custody_invitation_dismissed";
